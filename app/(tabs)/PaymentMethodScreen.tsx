...
import { RootStackParamList, PaymentFunder } from '../types';
import { COLORS, SPACING, RADIUS, SHADOW } from '../utils/theme';
import { Button, RadioItem } from '../components/UIComponents';
        ...
        <View style={styles.content}>
          ...
          <View style={styles.options}>
            ...
            >
              ...
              <View style={[styles.radio, funder === 'self' && styles.radioActive]}>
                {funder === 'self' && <View style={styles.radioDot} />}
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              style={[styles.option, funder === 'sponsored' && styles.optionActive]}
              onPress={() => setFunder('sponsored')}
              activeOpacity={0.8}
            >
              <Text style={styles.optionIcon}>💳</Text>
              <Text style={styles.optionLabel}>Sponsored payment</Text>
              <View style={[styles.radio, funder === 'sponsored' && styles.radioActive]}>
