...
const FloatingLabelInput = ({
  ...
  return (
    ...
    >
      ...
      {leftElement && (
        <View
          className={`h-full flex-row items-center pl-4 pr-3 border-r ${isDark ? "border-[#333333]" : "border-[#E5E5EA]"}`}
        >
          {leftElement}
        </View>
      )}
      ...
      {leftIcon && <View className="pl-4 pr-1">{leftIcon}</View>}
      ...
      {rightIcon && <View className="pr-4 justify-center">{rightIcon}</View>}
    </View>
  );
};
      ...
      >
        ...
        >
          ...
          <View className="items-center mt-12 mb-10">
            <Text
              className={`text-[24px] font-bold text-center ${isDark ? "text-white" : "text-[#1a1a1a]"}`}
            >
              Welcome to Berrystamp!
            </Text>
            <Text
              className={`text-center text-[15px] mt-2 ${isDark ? "text-[#A0A0A0]" : "text-[#666666]"}`}
            >
              You are signing up as a{" "}
              {isBusiness ? "Designer/Printer" : "Customer"}.{" "}
              {isBusiness
          ...
          <View className="flex-col gap-y-4">
            ...
            >
              <View
                className={`w-5 h-5 border-[1.5px] rounded mr-2.5 items-center justify-center ${sendUpdates ? "border-[#4B3A99] bg-[#4B3A99]" : "border-[#A0A0A0] bg-transparent"}`}
              >
                {sendUpdates && (
              ...
              <Text
                className={`text-[13.5px] flex-1 ${isDark ? "text-[#A0A0A0]" : "text-[#666666]"}`}
              >
            ...
            <View className="flex-row justify-center items-center mt-2 mb-4">
              <Text
                className={`text-sm ${isDark ? "text-[#A0A0A0]" : "text-[#666666]"}`}
              >
                Already have an account?{" "}
              </Text>
              <TouchableOpacity onPress={() => router.push("/login")}>
                <Text className="text-sm font-semibold text-[#4B3A99] dark:text-[#7A6AE6]">
                  Log in
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <Text
              className={`text-center text-xs leading-5 ${isDark ? "text-[#888888]" : "text-[#888]"}`}
            >
              By signing up, you agree to our{" "}
              <Text className="text-[#4B3A99] dark:text-[#7A6AE6]">
                terms of services
              </Text>{" "}
